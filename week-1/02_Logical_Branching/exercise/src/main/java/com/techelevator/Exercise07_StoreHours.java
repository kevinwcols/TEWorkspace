...
public class Exercise07_StoreHours {
    ...
    public boolean isStoreOpen(int currentHour, char currentDay, boolean isSummer) {
        ...
        else if ( ( ( currentHour >= 8 && currentHour < 17 ) && ( currentDay == 'M' || currentDay == 'F' ) && isSummer == true ) ||
                ( currentHour >= 8 && currentHour < 20 && currentDay == 'W' && isSummer ) ||
                ( currentHour >= 9 && currentHour < 15 && currentDay == 'S' && isSummer )  ) {
            return true;
        }
        return false;
    }
