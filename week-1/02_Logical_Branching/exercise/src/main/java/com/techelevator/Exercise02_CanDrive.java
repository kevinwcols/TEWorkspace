...
public class Exercise02_CanDrive {
     ...
     */
    int passengerAge21 = 21;

    public boolean canDrive(boolean hasPermit, boolean withLicensedPassenger, int passengerAge) {
        if ( hasPermit == true && withLicensedPassenger == true && passengerAge >= passengerAge21 ) {
            return true;
        }
        else if ( hasPermit == true && withLicensedPassenger == true && passengerAge <= passengerAge21 ) {
            return false;
        }
        return false;
    }
     ...
     */
    int passengerAge18 = 18;
    public boolean canDrive(boolean hasPermit, boolean withLicensedPassenger, int passengerAge, boolean isPassengerOurGuardian) {
        if ( hasPermit == true && withLicensedPassenger == true && passengerAge >= passengerAge18 && isPassengerOurGuardian == true ) {
            return true;
        }
        return false;
      }
